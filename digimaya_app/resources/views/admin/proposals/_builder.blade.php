{{--
    Inti builder proposal (dipindah VERBATIM dari proposals/edit.blade.php, Tahap 2b).
    Di-include DI DALAM <form x-data="proposalBuilder(...)"> sehingga mewarisi scope Alpine.
    Berisi: kartu Content Blocks, fungsi proposalBuilder(), Quill (CDN+gaya), upload gambar.
--}}
                {{-- Content Blocks --}}
