            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    ...
                    <form method="POST" action="{{ route('admin.proposal-snippets.update', $proposalSnippet) }}" class="space-y-6"
                          x-data="snippetForm({ initialBody: @js(old('body', $proposalSnippet->body)), initialImages: @js(old('images', $proposalSnippet->images ?? [])) })" @submit="syncEditorToInput()">
                        @csrf
                        @method('PUT')
                        ...
                        <div>
                            ...
                            <textarea name="body" id="body-input" class="hidden" maxlength="50000">{{ old('body', $proposalSnippet->body) }}</textarea>
                            {{-- Mount point Quill --}}
