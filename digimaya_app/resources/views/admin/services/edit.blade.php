    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <div>
                ...
                <div class="mt-2">
                    <x-breadcrumb :items="[['label' => 'Dashboard', 'url' => route('admin.dashboard')], ['label' => 'Services', 'url' => route('admin.services.index')], ['label' => 'Edit Service']]" />
                </div>
            </div>
        </div>
    </x-slot>
                ...
                <div class="p-6">
                    ...
                    <form method="POST" action="{{ route('admin.services.update', $service) }}" class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" id="name" name="name" value="{{ old('name', $service->name) }}" required maxlength="255"
                        ...
                        <div>
                            ...
                            <textarea id="description" name="description" rows="3" maxlength="5000"
                                      class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm px-3 py-2">{{ old('description', $service->description) }}</textarea>
                        </div>
